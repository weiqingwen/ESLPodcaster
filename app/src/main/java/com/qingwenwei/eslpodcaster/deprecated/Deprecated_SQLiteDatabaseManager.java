...
public class Deprecated_SQLiteDatabaseManager extends SQLiteOpenHelper {
    private static final String TAG = "Deprecated_SQLiteDatabaseManager";
    ...
    public Deprecated_SQLiteDatabaseManager(Context context){
